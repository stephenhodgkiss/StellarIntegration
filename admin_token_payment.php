...
<!-- 				<table class="col-md-10 table-bordered" style="color:white; padding:5px 5px">
					<tr style="background-color:#62cb31; text-align:center">
						...
						<td class="table-borders" style="padding:5px"><span style="font-size:14px">Balance</span></td>
					</tr>

 					<div id="data_balances" style="text-align:center; color:white"></div>

 					<tr style="text-align:center">
						<td class="table-borders" style="padding:5px"><span style="font-size:14px"><?=$member_id?></span></td>
						<td class="table-borders" style="padding:5px"><span style="font-size:14px"><?=$username?></span></td>
					</tr> -->
