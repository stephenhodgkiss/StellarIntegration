...
<head>
    ...
    <!-- Page title -->
    <title><?=$SITE_NAME?> Balances</title>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center">
				...
				<?php // echo "page=".$page." totalRecords=".$totalRecords." nextPage=".$nextPage." limitFrom=".$limitFrom." limitSize=".$limitSize."<br>"; ?>
		   ...
		   <div class="row">
		        ...
		        <div class="col-md-6">
					...
					<table class="form-group" style="font-size:16px">
						...
						<td for="pubkey" style="font-weight:bold; width:200px; text-align:right">Public Key</td>
						...
						<td style="padding-left:10px"><a href=# onclick="getBalance('<?=$network_status?>'); return false;" class="btn btn-success btn-block" style="font-size:16px">Show</a></td>
